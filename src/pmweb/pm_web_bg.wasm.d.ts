...
export const __wbg_pmengine_free: (a: number, b: number) => void;
export const pmengine_create: (a: any, b: number, c: number) => any;
export const pmengine_load_preset: (a: number, b: number, c: number) => number;
...
export const wasm_bindgen__convert__closures_____invoke__h0a5a8074da6f290a: (a: number, b: number, c: any) => void;
