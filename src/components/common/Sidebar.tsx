  ...
  return (
    <aside className="hidden md:flex md:w-56 lg:w-64 flex-col border-r border-border bg-bg-secondary">
      ...
      <div className="flex items-center gap-2 px-5 py-5">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="h-6 w-6 text-accent">
        ...
        <span className="text-lg font-bold text-text-primary">Vibrdrome</span>
      </div>
