...
type Theme = 'system' | 'dark' | 'light' | 'apple' | 'apple-dark' | 'spotify' | 'retro' | 'terminal' | 'midnight' | 'sunset';
...
const VALID_THEMES: Theme[] = ['system', 'dark', 'light', 'apple', 'apple-dark', 'spotify', 'retro', 'terminal', 'midnight', 'sunset'];
